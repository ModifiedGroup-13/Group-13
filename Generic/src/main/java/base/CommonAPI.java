...
public class CommonAPI {
    ...
    public String browserstack_username= "imranali17";
    public String browserstack_accesskey = "gTp6quse2qcN7XA8wwgH";
    ...
    public void setUp(@Optional("false") boolean useCloudEnv, @Optional("false")String cloudEnvName,
        ...
        WebDriver.Timeouts timeout = driver.manage().timeouts().pageLoadTimeout(25, TimeUnit.SECONDS);
